...
import styles from './AllkittiesPage.scss';
...
export default class AllkittiesPage extends React.Component {
        ...
        return (
            <PageTemplate header={<HeaderContainer Container__full metastatus={metastatus}/>}  padding responsive>
                <div className={cx('BrowsePage')}>
                    <Marketingheader type="all_kitties">
                    </Marketingheader>
                </div>

...
import styles from './Marketing_header.scss';
                ...
                <div className={cx('Filter-container')}>
                    ...
                    {(type === "for_sale") &&
                        <div className={cx('Filter-tabs')}>                                        
                            ...
                            <span className={cx('Filter-tab')}><a href="/marketplace/siring">Siring</a></span>
                            <span className={cx('Filter-tab')}><a href="/marketplace/gen0">Gen 0</a></span>
                            <span className={cx('Filter-tab')}><a href="/marketplace/all_kitties">All Kitties</a></span>
                    ...
                    {(type === "siring") &&
                        <div className={cx('Filter-tabs')}>                                        
                            ...
                            <span className={cx('Filter-tab','Filter-tab--active')}><a href="/marketplace/siring">Siring</a></span>
                            <span className={cx('Filter-tab')}><a href="/marketplace/gen0">Gen 0</a></span>
                            <span className={cx('Filter-tab')}><a href="/marketplace/all_kitties">All Kitties</a></span>
                            <span className={cx('Filter-tab')}><a href="/racing">Racing</a></span>
                            <span className={cx('Filter-tab')}><a href="/ico">ICO</a></span>
